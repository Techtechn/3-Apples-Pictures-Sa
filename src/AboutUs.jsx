...
const AboutUs = () => {
    return (
        <>
            ...
            <section className=" py-8 md:py-20 px-8 md:px-[12%]  relative bg-[#F5F5FA]">
                <div className=" grid md:grid-cols-3 md:gap-y-10">
                    {AboutLinks.map(({ icon, h2, li }) => (
                        <div className="  p-4  text-[#999999]   ">
                            ...
                            <ul className=" pl-0">
                                {li.map((text) => (
                                    <li className=" drop-shadow-md text-sm mb-1 flex items-start gap-2 pr-5">
                                        <span>
                                            <FaArrowRightLong
                                                size={10}
                ...
                <div className="  absolute inset-0 mix-blend-multiply h-full w-full flex justify-center items-end md:justify-end md:items-end opacity-10">
                    <img src={logo} alt="" />
                </div>
            </section>
